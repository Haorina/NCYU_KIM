...
class AbpSelectItem extends StatefulWidget {
  ...
  final String selectedTimeRatio;
  ...
  const AbpSelectItem({
    ...
    required this.selectedTimeRatio,
...
class _AbpSelectItemState extends State<AbpSelectItem> {
  ...
  late String selectedTimeRatio;

  @override
  void initState() {
    super.initState();
    isSelected = widget.isSelected;
    selectedTimeRatio = widget.selectedTimeRatio;
  }

  @override
  void didUpdateWidget(covariant AbpSelectItem oldWidget) {
    super.didUpdateWidget(oldWidget);

    if (widget.isSelected != isSelected ||
        widget.selectedTimeRatio != selectedTimeRatio) {
      setState(() {
        isSelected = widget.isSelected;
        selectedTimeRatio = widget.selectedTimeRatio;
      });
      ...
      child: Stack(
        children: [
          Positioned(
            ...
            child: circle(screenHeight * 0.124, const Color(0xFFECECEC)),
          ),
          Positioned(
          ...
          Positioned(
            ...
            left: imgOffsetLeft - screenWidth * 0.024,
            child: SizedBox(
              width: imgWidth,
          ...
          if (widget.help) ...[
            Positioned(top: 0, left: screenWidth * 0.52, child: widget.icon!),
          ],
        ],
      ),
    );
